...
* **📜 破局长文与工业批判**
  * [400 年还原论惯性突破](Article_1_400Year_Reductionism_Breakthrough.md)
  * [离散制造转型的迷途与破局](Article_3_Discrete_Manufacturing_Breakthrough.md)
...
* **💻 IPC 普适产品与工程审计**
  ...
  * <a href="IPC_Governance_Showcase.html" target="_blank">3D 全息拓扑交互演示</a>
  * <a href="IPC_Video_Lectures.html" target="_blank">IPC 视频讲堂</a>
...
* **📂 学科大纲与精选章节**
  ...
  * **02. 认知革命与变革杠杆**
    ...
    * [16a. 五维心智物理引擎与认知OS](02_认知革命与变革杠杆/16a_良知驱动五维心智物理引擎与认知OS.md)
    * [16d. 供应链物理法则与硅基抗熵终局](02_认知革命与变革杠杆/16d_历史的宣判：供应链的物理法则与硅基抗熵的终局.md)
  * **03. 三层数据模型与物理镜像**
    * [17. 数据本体双螺旋结构](03_三层数据模型与物理镜像/17_数据本体双螺旋结构.md)
    * [18. ODM 物理世界的精确镜像](03_三层数据模型与物理镜像/18_ODM_物理世界的精确镜像.md)
    * [19. CDM 决策规则与算法大脑](03_三层数据模型与物理镜像/19_CDM_决策规则与算法大脑.md)
    * [20. DDM 全息分析与模拟推演](03_三层数据模型与物理镜像/20_DDM_全息分析与模拟推演.md)
  * **04. 专利数学与消纳算法**
  ...
  * **05. 工程天堑与 AI 审判**
    * [36. 价值链物理学科学性自审与证伪边界](05_工程天堑与AI审判/36_价值链物理学的科学性自审与证伪边界.md)
    * [37. 系统科学到 IPC 创新度审计](05_工程天堑与AI审判/37_系统科学到IPC的科学评估与创新度审计.md)
