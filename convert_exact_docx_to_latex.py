...
print(f"Reading author's exact document from {doc_path}...")
doc = docx.Document(doc_path)
paragraphs = [p.text.strip() for p in doc.paragraphs if p.text.strip()]

# Convert paragraphs to canonical English LaTeX
...
print(f"Generated 100% strictly matched main.tex from author's docx! Size: {len(cleaned_tex)} bytes")
