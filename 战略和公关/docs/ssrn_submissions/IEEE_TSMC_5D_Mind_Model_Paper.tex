...
\thanks{Grit Meng (Fanchun Meng / 孟凡淳) is the Founder and Chief Scientist of the Value Chain Physics \& Metacognitive Cybernetics Laboratory, Beijing, China (e-mail: gritmeng@outlook.com). ORCID: 0009-0004-9840-9494.}}
...
\end{equation}
By Gödel's Incompleteness Theorem \cite{godel1931formally}, any formal consistent system $\mathcal{T}$ of sufficient complexity contains propositions that cannot be decided within $\mathcal{T}$. Thus, first-order task execution cannot self-verify its own ethical and structural validity.
...
The holographic metacognitive control engine is specified in Algorithm~\ref{alg:holographic_governance}.
...
\begin{enumerate}
    ...
    \item \textbf{Step 2 (Risk Gradient Evaluation)}: Calculate risk gradient $\|\nabla R(t)\|$.
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{letter.jpg}}]{Grit Meng (Fanchun Meng / 孟凡淳)}
