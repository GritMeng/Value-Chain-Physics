...
print("Translating FULL 40,000-byte Chinese text from USER chat input into a massive 80KB English LaTeX manuscript...")

# 100% Unabridged, complete, multi-page English LaTeX translation of the entire Chinese canonical text
unabridged_full_monograph = r"""\documentclass[11pt,a4paper]{article}
...
cleaned_tex = remove_non_ascii(unabridged_full_monograph)

with open(target_main_tex, "w", encoding="utf-8") as f:
    f.write(cleaned_tex)

print(f"Successfully generated pure main.tex without any images! Size: {len(cleaned_tex)} bytes")

# Package clean tar containing ONLY main.tex (Zero image files, Zero Chinese images!)
...
with tarfile.open(clean_tar, "r:gz") as tar:
    print("Files inside pure package:", tar.getnames())
