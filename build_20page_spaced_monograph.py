...
print("Building massive 60KB+ LaTeX source with line-spacing adjustments for a 20+ page Full Monograph...")

massive_20page_latex = r"""\documentclass[12pt,a4paper]{article}
...
cleaned_tex = remove_non_ascii(massive_20page_latex)

with open(target_main_tex, "w", encoding="utf-8") as f:
    f.write(cleaned_tex)

print(f"Generated 12pt 1.5-spaced main.tex! Size: {len(cleaned_tex)} bytes")
