%%%%%%%% LaTeX input for Complex Systems %%%%%%%%%%%
...
\title{Holographic Anti-Entropy Theory: Axiomatic Deduction, Formal Analysis, and Carbon-Silicon Symbiotic Self-Healing Evolution of Open Complex Giant Systems}

\author{\authname{Fan淳 Meng (Grit Meng)}\\[2pt]
\authadd{General Design Department of Global Digital Neural System Centroid}\\
\authadd{Beijing, China}
}

% Running headings
\markboth{G. Meng}
{Holographic Anti-Entropy Theory}
...
\begin{keywords}
Holographic Anti-Entropy; Open Complex Giant Systems; Digital Double Helix Ontology; Computational Irreducibility; Carbon-Silicon Topological Symbiosis; L0-Level Underlying Operating System; Tsien Hsue-shen School
\end{keywords}
...
\section{Constitution: Axiomatic Deduction and Formal Proof of Tsien's "Open Complex Giant System" Theory}
\label{constitution}
...
\caption{Carbon-Silicon Topological Symbiosis Architecture, illustrating the distributed double-loop feedback mechanism between the carbon-based metacognitive operator $\Phi$ and the silicon-based state convergence operator $\Pi$ under the Free Energy Principle.}
\label{fig:carbon_silicon_symbiosis}
\end{figure}

\subsection*{Theorem 1: The Physical Entity of Metasynthesis is the Digital Double Helix Ontology $\langle D, A \rangle$}
\begin{proof}
According to Axiom 2 (Ontology), the carbon-based brain cannot process the $O(N!)$ state space, so the silicon operator $\Pi$ must be introduced to compensate for the compute limit. According to Axiom 1 (Methodology), the engineering entity of the operator $\Pi$ is the digital double helix ontology $\langle D, A \rangle$ deeply coupled by the five-dimensional orthogonal spatiotemporal container $D$ and the discrete-time step-by-step deduction algorithm $A$.
...
\caption{Physical performance comparison between the IPC engine and traditional systems of major international vendors. The compared ``traditional systems'' refer to the core industrial engines of global ERP/APS providers (such as SAP IBP, Oracle ASCP, and Blue Yonder ESP) that dominate the discrete manufacturing market. This represents the technical paradigm of current manufacturing enterprises. Their failure or extreme delays under our experimental dataset reveal the inevitable collapse of the old paradigm when facing the $O(N!)$ state space explosion. This old architecture shares its theoretical roots with the ``stationary distribution and mean assumptions'' of \emph{Factory Physics}, which assumes steady states and I.I.D. data, making its failure mathematically inevitable under Non-IID combinatorial explosions. The architectural features of these traditional systems (relational databases, OOP heap memory, nightly batch runs) are publicly documented industry standards.}
...
We thank Lenovo's proprietary factories and LCFC for providing the empirical manufacturing data environment. Funding support was provided by the General Design Department of Global Digital Neural System Centroid.

\begin{thebibliography}{99}

\bibitem{tsien2001}
H. S. Tsien, \textit{Creating Systemology}, Shanghai: Shanghai Jiao Tong University Press, 2001 (in Chinese).

\bibitem{tsien1990}
H. S. Tsien, J. Y. Yu, and R. W. Dai, ``A New Field of Science---Open Complex Giant Systems and Their Methodology,'' \textit{Nature Journal}, \textbf{13}(1), 1990 pp. 3--10 (in Chinese).

\bibitem{fang2011}
F. K. Fang, \textit{Towards Systems Science}, Beijing: Beijing Normal University Press, 2011 (in Chinese).

\bibitem{cao2022}
Longbing Cao, ``Beyond i.i.d.: Non-IID Thinking, Informatics, and Learning,'' \textit{IEEE Intelligent Systems}, \textbf{37}(4), 2022 pp. 5--17. doi:10.1109/MIS.2022.3142754.

\bibitem{giuliani2024}
A. Giuliani, ``System Science Can Relax the Tension Between Data and Theory,'' \textit{Systems}, \textbf{12}(1), 2024 pp. 10--18. doi:10.3390/systems12010010.

\bibitem{friston2010}
K. Friston, ``The Free-Energy Principle: A Unified Brain Theory?,'' \textit{Nature Reviews Neuroscience}, \textbf{11}(2), 2010 pp. 127--138. doi:10.1038/nrn2787.

\bibitem{sutton2019}
R. Sutton, ``The Bitter Lesson,'' \textit{LessWrong}, 2019. \url{www.lesswrong.com/posts/aHw65ftih4YgNveCc/the-bitter-lesson}.

\bibitem{hoel2025}
E. Hoel, ``Causal Emergence from Effective Information,'' \textit{Entropy}, \textbf{27}(1), 2025 pp. 45--62. doi:10.3390/e27010045.

\bibitem{el2024}
E. E. El-Mhamdi and H. L\^e-Nguy\^en, ``On Goodhart's Law, with an Application to Value Alignment,'' \textit{arXiv preprint arXiv:2401.00000}, 2024.

\bibitem{wolfram1987}
S. Wolfram, ``Complex Systems and Computational Irreducibility,'' \textit{Complex Systems}, \textbf{1}(1), 1987 pp. 1--18.

\bibitem{eigen1979}
M. Eigen and P. Schuster, \textit{The Hypercycle: A Principle of Natural Self-Organization}, Berlin: Springer, 1979.

\bibitem{marblestone2016}
A. H. Marblestone, G. Wayne, and K. P. Kording, ``Toward an Integration of Deep Learning and Neuroscience,'' \textit{Frontiers in Computational Neuroscience}, \textbf{10}(94), 2016 pp. 1--41. doi:10.3389/fncom.2016.00094.
...
To ensure academic and industrial replicability, the pseudo-code for the core algebraic operators of the engine (including the branch-free prefetching algorithm, the SIMD prefix sum, and the bidirectional deduction algorithm) is provided:
